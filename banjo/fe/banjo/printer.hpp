...
// most recent version of the banjo parser. The class livers here 
// primarily to support compiler debugging.
//
...
struct Printer
{
  ...
  void spaced_token(char);
  void spaced_token(char const*);
